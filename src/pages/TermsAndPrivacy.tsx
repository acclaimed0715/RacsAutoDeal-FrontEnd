    ...
    return (
        <div className="landing-page legal-page">
            ...
            <div className="legal-hero">
                <h1>
                    Legal <span className="text-primary">Hub</span>
                </h1>
            ...
            <div className="legal-container">
                ...
                <section id="terms" className="legal-section">
                    ...
                    <div className="legal-box">
                        <p>Welcome to RACS AUTO DEAL. By accessing our website, you agree to comply with and be bound by the following terms and conditions of use.</p>
